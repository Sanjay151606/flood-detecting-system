...
ACCOUNT_SID  = os.getenv("TWILIO_ACCOUNT_SID", "AC_MOCK_SID_FOR_LOCAL")
AUTH_TOKEN   = os.getenv("TWILIO_AUTH_TOKEN", "mock_auth_token_for_local")
TWILIO_PHONE = os.getenv("TWILIO_PHONE_NUMBER", "+10000000000")
